      ...
      {!isLoading && (
        <div className="min-h-screen bg-[#0A0A0A] text-white overflow-x-hidden">
          ...
          <main>
            ...
            {/* ── Challenge & Solution ── */}
            <section className="py-24 md:py-32 px-6 bg-[#070707] border-y border-white/5 mt-20">
              <div className="max-w-7xl mx-auto">
                <div className="grid md:grid-cols-2 gap-8 md:gap-16">
                  {/* Challenge */}
                  <ScrollReveal direction="right" delay={0}>
                    <div className="bg-[#0A0A0A] border border-white/8 rounded-3xl p-8 md:p-10 h-full group hover:border-red-500/30 transition-all duration-500">
                  ...
                  <ScrollReveal direction="left" delay={150}>
                    <div className="bg-[#0A0A0A] border border-white/8 rounded-3xl p-8 md:p-10 h-full group hover:border-brand/30 transition-all duration-500">
                      <div className="flex items-center gap-4 mb-8">
